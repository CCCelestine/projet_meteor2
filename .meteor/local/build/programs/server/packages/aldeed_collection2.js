...
function doValidate(collection, type, args, getAutoValues, userId, isFromTrustedCode) {
  ...
  const extendAutoValueContext = _extends({}, (schema._cleanOptions || {}).extendAutoValueContext || {}, autoValueContext, options.extendAutoValueContext);
  ...
  if (options.validate === false) {
    ...
    isValid = validationContext.validate(docToValidate, {
      ...
      upsert: isUpsert,
      extendedCustomContext: _extends({
        isInsert: type === "insert",
        isUpdate: type === "update" && options.upsert !== true,
        isUpsert,
        userId,
